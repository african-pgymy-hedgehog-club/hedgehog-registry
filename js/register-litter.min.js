!function a(b, c, d) {
    ...
    6: [ function(a, b, c) {
        ...
        a("es6-promise");
        var k = a("react"), l = d(k), m = a("react-dom"), n = d(m), o = a("./form-base"), p = d(o), q = a("./payment-modal"), r = d(q), s = a("./uikit-form"), t = d(s), u = a("./input"), v = d(u), w = a("./dob-input"), x = d(w), y = a("moment"), z = d(y), A = a("./input-group"), B = d(A), C = 2, D = function(a) {
            function b() {
                f(this, b);
            ...
            return h(b, a), j(b, [ {
                ...
                value: function(a, b, c) {
                    ...
                    var e = [ "name", "gender", "colour", "image", "owner_name", "owner_address", "hr" ], f = e.map(function(e, f) {
                        var g = void 0;
