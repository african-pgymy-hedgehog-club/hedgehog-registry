            ...
            return h(b, a), j(b, [ {
                ...
                value: function c() {
                    ...
                    return this.state.hoglets.forEach(function(b, d) {
                        var e = b.id, f = b.name, g = b.visible;
                        if (e > 1) {
                            var h = l["default"].createElement(B["default"], {
                                onClick: function() {
                                    a.removeHoglet(e);
                                },
                                key: e
                        ...
                        if (a.state.hoglets.length > 1) {
                            var i = l["default"].createElement(B["default"], {
                                style: {
                                    marginLeft: -150,
                                    cursor: "pointer"
                                },
                                ...
                                onClick: function() {
                                    a.setState({
                                        hoglets: a.state.hoglets.map(function(a) {
                                            return a.id === e && (a.visible = !a.visible), a;
                                        })
                                    });
                                }
                            }, l["default"].createElement("i", {
                                className: g ? "uk-icon-angle-left" : "uk-icon-angle-down",
                                style: {
                                    marginRight: 10
                                }
                            }), l["default"].createElement("b", null, f.value));
                            c.push(i);
                        }
                        g && a.hogletInputTypes(e, d, c);
                    }), c;
                }
            }, {
                ...
                value: function() {
                    ...
                    }, "Add Hedgehog")), this.hogletInputs()));
                }
            } ]), b;
        }(p["default"]);
