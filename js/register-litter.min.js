!function a(b, c, d) {
    ...
    7: [ function(a, b, c) {
        ...
        a("es6-promise");
        var k = a("react"), l = d(k), m = a("react-dom"), n = d(m), o = a("./form-base"), p = d(o), q = a("./payment-modal"), r = d(q), s = a("./uikit-form"), t = d(s), u = a("./input"), v = d(u), w = a("./dob-input"), x = d(w), y = a("moment"), z = d(y), A = a("./input-group"), B = d(A), C = a("./hog-type"), D = d(C), E = 1, F = function(a) {
            function b() {
                f(this, b);
            ...
            return h(b, a), j(b, [ {
                ...
                value: function(a, b, c, d) {
                    ...
                    var e = this.state.hoglets.map(function(e, f) {
                        return e.id === a && (e[b] = i({
                            ref: d
                        }, c)), e;
                    });
                ...
                value: function(a, b, c) {
                    var d = this, e = [ "name", "gender", "colour", "image", "owner_name", "owner_address", "owner_email", "hr" ], f = e.map(function(e, f) {
                        var g = void 0, h = b + 1;
        ...
        "undefined" != typeof window && window.document ? n["default"].render(l["default"].createElement(F, null), document.getElementById("app")) : b.exports = F;
    }, {
        "./dob-input": 1,
        "./form-base": 2,
        "./hog-type": 3,
    ...
    8: [ function(a, b, c) {
        ...
        var e = a("react"), f = d(e), g = function(a) {
            var b = a.type, c = a.onSubmit, d = a.children, e = a.style, g = void 0 === e ? {} : e, h = a.referance, i = a.action, j = void 0 === i ? null : i, k = [ "input", "Input", "text", "email", "select", "HogType", "DOB", "dob", "file", "number", "textarea", "i" ], l = "uk-form uk-form-" + b;
            ...
            return d = Array.isArray(d) ? d : [ d ], f["default"].createElement("form", {
                ...
                return a = Array.isArray(a) ? a : [ a ], a.map(function(a, c) {
                    var d = a.props.name, e = a.props.type || a.type.name || a.type;
                    return "Input" == e && ("hidden" == a.props.type && (e = "hidden"), "submit" == a.props.type && (e = "submit")), 
                    -1 !== k.indexOf(e) ? a = f["default"].createElement("div", {
                        className: "uk-form-row",
                        key: "" + b + c
                    }, f["default"].createElement("label", {
                        className: "uk-form-label",
                        htmlFor: d
                    }, d.replace(/(!affix)([\d]+)/g, "").replace(/_/g, " ").replace(/\b[a-z]/g, function(a) {
                        return a.toUpperCase();
                    }), ":"), f["default"].createElement("div", {
                        className: "uk-form-controls"
                    }, a)) : "hidden" !== e && "submit" !== e && "hr" !== e ? a = f["default"].createElement("div", {
                        className: "uk-form-row",
                        key: "" + b + c
                    }, f["default"].createElement("div", {
                        className: "uk-form-controls"
                    }, a)) : "hidden" !== e && (a = f["default"].createElement("div", {
                        className: "uk-form-row",
                        key: "" + b + c
                    }, a)), a;
                });
    ...
    42: [ function(a, b, c) {
        ...
        "lodash._bindcallback": 41,
        "lodash._isiterateecall": 44,
        "lodash.restparam": 49
    } ],
    43: [ function(a, b, c) {
        function d(a) {
    ...
    45: [ function(a, b, c) {
        ...
        "lodash._baseassign": 39,
        "lodash._createassigner": 42,
        "lodash.keys": 48
    } ],
    46: [ function(a, b, c) {
        function d(a) {
    ...
    48: [ function(a, b, c) {
        ...
        "lodash._getnative": 43,
        "lodash.isarguments": 46,
        "lodash.isarray": 47
    } ],
    49: [ function(a, b, c) {
        function d(a, b) {
    ...
    61: [ function(a, b, c) {
        ...
        "./EventConstants": 73,
        "./EventPropagators": 77,
        "./FallbackCompositionState": 78,
        "./SyntheticCompositionEvent": 149,
        "./SyntheticInputEvent": 153,
    ...
    65: [ function(a, b, c) {
        ...
        "./SyntheticEvent": 151,
        "./getEventTarget": 173,
        "./isEventSupported": 178,
        "./isTextInputElement": 179,
        "fbjs/lib/ExecutionEnvironment": 13,
        "fbjs/lib/keyOf": 31
    } ],
    66: [ function(a, b, c) {
    ...
    67: [ function(a, b, c) {
        ...
        "./Danger": 70,
        "./ReactMultiChildUpdateTypes": 126,
        "./ReactPerf": 130,
        "./setInnerHTML": 183,
        "./setTextContent": 184,
        "fbjs/lib/invariant": 27
    ...
    69: [ function(a, b, c) {
        ...
        "./DOMProperty": 68,
        "./ReactPerf": 130,
        "./quoteAttributeValueForBrowser": 181,
        "fbjs/lib/warning": 38
    } ],
    70: [ function(a, b, c) {
        "use strict";
    ...
    74: [ function(a, b, c) {
        ...
        "./EventPluginRegistry": 75,
        "./EventPluginUtils": 76,
        "./ReactErrorUtils": 115,
        "./accumulateInto": 161,
        "./forEachAccumulated": 169,
        "fbjs/lib/invariant": 27,
        "fbjs/lib/warning": 38
    } ],
    75: [ function(a, b, c) {
    ...
    88: [ function(a, b, c) {
        ...
        "./ReactComponent": 89,
        "./ReactElement": 111,
        "./ReactNoopUpdateQueue": 128,
        "./ReactPropTypeLocationNames": 131,
        "./ReactPropTypeLocations": 132,
    ...
    92: [ function(a, b, c) {
        ...
        "./Object.assign": 81,
        "./ReactComponentEnvironment": 91,
        "./ReactCurrentOwner": 93,
        "./ReactElement": 111,
        "./ReactInstanceMap": 121,
        "./ReactPerf": 130,
        "./ReactPropTypeLocationNames": 131,
    ...
    94: [ function(a, b, c) {
        ...
        "./ReactCurrentOwner": 93,
        "./ReactDOMTextComponent": 105,
        "./ReactDefaultInjection": 108,
        "./ReactInstanceHandles": 120,
        "./ReactMount": 124,
        "./ReactPerf": 130,
        "./ReactReconciler": 135,
        "./ReactUpdates": 142,
    ...
    96: [ function(a, b, c) {
        ...
        "./AutoFocusUtils": 60,
        "./CSSPropertyOperations": 63,
        "./DOMProperty": 68,
        "./DOMPropertyOperations": 69,
        "./EventConstants": 73,
        "./Object.assign": 81,
        "./ReactBrowserEventEmitter": 85,
        "./ReactComponentBrowserEnvironment": 90,
        "./ReactDOMButton": 95,
        "./ReactDOMInput": 100,
        "./ReactDOMOption": 101,
        "./ReactDOMSelect": 102,
        "./ReactDOMTextarea": 106,
        "./ReactMount": 124,
        "./ReactMultiChild": 125,
        "./ReactPerf": 130,
        "./ReactUpdateQueue": 141,
        "./canDefineProperty": 163,
        "./escapeTextContentForBrowser": 166,
        "./isEventSupported": 178,
        "./setInnerHTML": 183,
        "./setTextContent": 184,
    ...
    108: [ function(a, b, c) {
        ...
        "./BeforeInputEventPlugin": 61,
        "./ChangeEventPlugin": 65,
        "./ClientReactRootIndex": 66,
        "./DefaultEventPluginOrder": 71,
        "./EnterLeaveEventPlugin": 72,
        "./HTMLDOMPropertyConfig": 79,
        "./ReactBrowserComponentMixin": 84,
        "./ReactComponentBrowserEnvironment": 90,
        "./ReactDOMComponent": 96,
        "./ReactDOMTextComponent": 105,
        "./ReactDefaultBatchingStrategy": 107,
        "./ReactDefaultPerf": 109,
        "./ReactEventListener": 117,
        "./ReactInjection": 118,
        "./ReactInstanceHandles": 120,
        "./ReactMount": 124,
        "./ReactReconcileTransaction": 134,
        "./SVGDOMPropertyConfig": 144,
        "./SelectEventPlugin": 145,
        "./ServerReactRootIndex": 146,
        "./SimpleEventPlugin": 147,
        "fbjs/lib/ExecutionEnvironment": 13
    } ],
    109: [ function(a, b, c) {
        "use strict";
    ...
    113: [ function(a, b, c) {
        ...
        "./Object.assign": 81,
        "./ReactElement": 111,
        "./ReactEmptyComponentRegistry": 114,
        "./ReactReconciler": 135
    } ],
    114: [ function(a, b, c) {
        "use strict";
    ...
    118: [ function(a, b, c) {
        ...
        "./ReactClass": 88,
        "./ReactComponentEnvironment": 91,
        "./ReactEmptyComponent": 113,
        "./ReactNativeComponent": 127,
        "./ReactPerf": 130,
        "./ReactRootIndex": 137,
        "./ReactUpdates": 142
    } ],
    ...
    124: [ function(a, b, c) {
        ...
        "./ReactBrowserEventEmitter": 85,
        "./ReactCurrentOwner": 93,
        "./ReactDOMFeatureFlags": 98,
        "./ReactElement": 111,
        "./ReactEmptyComponentRegistry": 114,
        "./ReactInstanceHandles": 120,
        "./ReactInstanceMap": 121,
        "./ReactMarkupChecksum": 123,
        "./ReactPerf": 130,
        "./ReactReconciler": 135,
        "./ReactUpdateQueue": 141,
        "./ReactUpdates": 142,
    ...
    139: [ function(a, b, c) {
        ...
        "./ReactInstanceHandles": 120,
        "./ReactMarkupChecksum": 123,
        "./ReactServerBatchingStrategy": 138,
        "./ReactServerRenderingTransaction": 140,
        "./ReactUpdates": 142,
        "./instantiateReactComponent": 177,
        "fbjs/lib/emptyObject": 20,
        "fbjs/lib/invariant": 27
    ...
    147: [ function(a, b, c) {
        ...
        "./EventPropagators": 77,
        "./ReactMount": 124,
        "./SyntheticClipboardEvent": 148,
        "./SyntheticDragEvent": 150,
        "./SyntheticEvent": 151,
        "./SyntheticFocusEvent": 152,
        "./SyntheticKeyboardEvent": 154,
        "./SyntheticMouseEvent": 155,
        "./SyntheticTouchEvent": 156,
        "./SyntheticUIEvent": 157,
        "./SyntheticWheelEvent": 158,
