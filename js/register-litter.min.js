!function a(b, c, d) {
    ...
    1: [ function(a, b, c) {
        ...
        var e = a("react"), f = d(e), g = a("./input"), h = d(g), i = function(a) {
            var b = a.name, c = a.data, d = a.required, e = void 0 === d ? !1 : d, g = a.parentUpdateState, i = void 0 === g ? {} : g;
            a.value;
            ...
            return g(b, a), i(b, [ {
                ...
                value: function() {
                    ...
                    switch (b) {
                      ...
                      case "date":
                        var k = /^([0-9]+-{2}[0-9]+-{2}[0-9]{4})?$/;
                        k.test(i) ? i.length < 2 && f ? this.setState({
                            valid: !1,
                            invalidMessage: c + " is not valid",
                            value: i
                        }) : this.setState({
                ...
                key: "input",
                value: function(a) {
                    var b = this, c = this.props, d = c.type, e = c.name, f = c.className, g = this.props["data-uk-datepicker"] || !1;
                    ...
                    return g && (i["data-uk-datepicker"] = g), k["default"].createElement("input", h({}, i, {
                        onChange: function() {
                            return b.setState({
    ...
    6: [ function(a, b, c) {
        ...
        var m = function(a, b) {
            ...
            f["default"].createElement(h["default"], {
            ...
            }))), f["default"].createElement("p", null, p), f["default"].createElement(j["default"], {
                type: "horizontal",
                ...
                type: "hidden",
                name: "item_name_1",
                value: (n + " " + o + " registration").ucwords()
            }), f["default"].createElement(l["default"], {
                type: "hidden",
                name: "amount_1",
                value: "1"
                ...
                value: "Pay for your " + o + " registration"
            }))));
        };
        c["default"] = n;
    }, {
        ...
        var k = a("react"), l = d(k), m = a("react-dom"), n = d(m), o = a("./form-base"), p = d(o), q = a("./payment-modal"), r = d(q), s = a("./uikit-form"), t = d(s), u = a("./input"), v = d(u), w = a("./dob-input"), x = d(w), y = a("moment"), z = d(y), A = a("./input-group"), B = d(A), C = a("./hog-type"), D = d(C), E = 1, F = function(a) {
            ...
            return h(b, a), j(b, [ {
                ...
                value: function() {
                    ...
                    return l["default"].createElement("div", {
                    ...
                    }, l["default"].createElement(D["default"], null), l["default"].createElement(v["default"], {
                        type: "text",
                        name: "breeder_name",
                        ...
                        data: {
                            format: "DD/MM/YYYY",
                            minDate: (0, z["default"])(new Date()).subtract(3, "years").format("DD.MM.YYYY"),
                            maxDate: (0, z["default"])(new Date()).subtract(2, "weeks").format("DD.MM.YYYY")
                        },
                        type: "dob",
                        required: !0
    ...
    8: [ function(a, b, c) {
        ...
        var e = a("react"), f = d(e), g = function(a) {
            var b = a.type, c = a.onSubmit, d = a.children, e = a.style, g = void 0 === e ? {} : e, h = a.referance, i = a.action, j = void 0 === i ? null : i, k = [ "input", "Input", "text", "email", "select", "HogType", "DOB", "dob", "file", "textarea" ], l = "uk-form uk-form-" + b;
            ...
            return d = Array.isArray(d) ? d : [ d ], f["default"].createElement("form", {
                ...
                return a = Array.isArray(a) ? a : [ a ], a.map(function(a, c) {
                    var d = a.props.name || a.type.name, e = a.props.type || a.type.name || a.type;
                    ...
                    -1 !== k.indexOf(e) ? a = f["default"].createElement("div", {
                        ...
                        return a.toUpperCase();
                    }).replace("HogType", "Hog Type"), ":"), f["default"].createElement("div", {
