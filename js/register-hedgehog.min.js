!function a(b, c, d) {
    ...
    8: [ function(a, b, c) {
        ...
        }(), j = a("es6-promise"), k = (d(j), a("react")), l = d(k), m = a("./uikit-form"), n = d(m), o = a("./dob-input"), p = d(o), q = a("react-dom"), r = d(q), s = a("moment"), t = d(s), u = a("./input-group"), v = (d(u), 
        a("./input")), w = d(v), x = a("./payment-modal"), y = d(x), z = a("./form-base"), A = d(z), B = a("./hog-type"), C = d(B), D = a("./pet-only"), E = d(D), F = function(a) {
            function b() {
                return e(this, b), f(this, Object.getPrototypeOf(b).call(this));
            }
            return g(b, a), i(b, [ {
                key: "submitForm",
                value: function(a) {
                        ...
                        if (a && console.error(a), c) {
                            ...
                            b.setState({
                                ...
                                if (a.error) throw b.setState({
                                    paymentModal: h({}, b.state.paymentModal, {
                                        loading: !1
                                    }),
                                    error: !0
                                }), a.error;
                ...
                value: function() {
                    ...
                    return l["default"].createElement("div", {
                        ...
                        loading: e
                    }), l["default"].createElement("h2", null, "Register Hedgehog"), l["default"].createElement(n["default"], {
                        type: "horizontal",
                        style: {
                            marginLeft: "20%",
                            paddingBottom: 15
                        ...
                        value: "female"
                    }, "Female")), l["default"].createElement(p["default"], {
                        name: "date_of_birth",
                        data: {
                            format: "DD/MM/YYYY",
                            minDate: (0, t["default"])(new Date()).subtract(5, "years").format("YYYY-MM-DD"),
                            maxDate: (0, t["default"])(new Date()).subtract(2, "weeks").format("YYYY-MM-DD")
                        },
                        type: "dob",
                        required: !0,
                        parentUpdateState: this.inputState.bind(this),
                        ...
                        parentUpdateState: this.inputState.bind(this),
                        value: (this.state.inputs.pet_only || {
                            value: ""
                        }).value
                    }), l["default"].createElement(w["default"], {
                        type: "text",
                        ...
                        rows: "7",
                        name: "owners_address"
                    }, (this.state.inputs.owners_address || {
                        value: ""
                    }).value), l["default"].createElement(w["default"], {
                        type: "email",
        ...
        "undefined" != typeof window && window.document ? r["default"].render(l["default"].createElement(F, null), document.getElementById("app")) : b.exports = F;
    }, {
        "./dob-input": 1,
        "./form-base": 2,
        "./hog-type": 3,
