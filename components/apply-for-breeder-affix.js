...
class RegisterHedgehog extends FormBase {
    ...
    submitForm(e) {
        ...
        this.formValid((err, valid) => {
            ...
            if (valid) {
                ...
                fetch("/api/register/apply-for-breeder-affix", {
    ...
    modalLoadingError(loading, error) {
        ...
        if (loading) {
            ...
            setTimeout(
                () => this.setState({ displayModal: false, error: false }),
                5000
            );
            display = (
            ...
            >
                ...
                >
                    {this.state.error || this.state.loadingModal ? (
                        this.modalLoadingError(
                            this.state.loadingModal,
                            this.state.error
                        )
                    ) : (
                        <h3>
                            We will contact you to let you know which of your
                            affix choices is available
                        </h3>
                    )}
                </Modal>

                <h2>Apply For Breeder Affix</h2>
                ...
                >
                    ...
                    <Input
                        ...
                        parentUpdateState={this.inputState.bind(this)}
                        value={
                            (this.state.inputs.affix_choice_1 || { value: "" })
                                .value
                        }
                    />
                    ...
                    <Input
                        ...
                        parentUpdateState={this.inputState.bind(this)}
                        value={
                            (this.state.inputs.affix_choice_2 || { value: "" })
                                .value
                        }
                    />
