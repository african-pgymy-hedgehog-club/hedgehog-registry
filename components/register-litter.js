            ...
            if (id > 1) {
                let removeHedgehog = (
                    <InputGroup onClick={() => this.removeHoglet(id)} key={id}>
                        <i
                            className="uk-icon-times-circle"
                            style={{
                                color: "#d00",
                                marginRight: 10,
                                cursor: "pointer",
            ...
            if (
                ...
                element = (
                    <Input
                        ...
                        value={
                            (
                                this.state.hoglets[hogletIndex][inputType] || {
                                    value: "",
                                }
                            ).value
                        }
                ...
                element = (
                    <select
                        name={`hedgehog_gender${hogletNum}`}
                        key={`${id}${index}`}
                    >
            ...
            >
                ...
                >
                    ...
                    <Input
                        ...
                        parentUpdateState={this.inputState.bind(this)}
                        value={
                            (this.state.inputs.sire_reg_number || { value: "" })
                                .value
                        }
                    />
                    ...
                    <Input
                        ...
                        parentUpdateState={this.inputState.bind(this)}
                        value={
                            (this.state.inputs.dam_reg_number || { value: "" })
                                .value
                        }
                    />
...
if (typeof window !== "undefined" && window.document) {
    ...
    /* jshint ignore: start */
    ReactDOM.render(<RegisterLitter />, document.getElementById("app"));
    /* jshint ignore: end */
} else {
